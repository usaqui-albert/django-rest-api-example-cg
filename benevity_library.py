...
class Benevity(object):
    ...
    @get
    def get_cause_profile(self, **kwargs):
        """Method to get url path for the GetCauseProfile endpoint"""
        return self.get_url_request('GetCauseProfile', **kwargs)
    ...
    @get
    def get_receipt_detail(self, **kwargs):
        """Method to get url path for the GetReceiptDetails endpoint"""
        return self.get_url_request('GetReceiptDetails', **kwargs)
